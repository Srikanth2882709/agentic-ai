...
export function ChatHistory() {
  ...
  // ✅ FIXED: Lazy initialization - Date.now() only runs once on mount
  const [currentTime, setCurrentTime] = useState(() => Date.now());

  // ✅ FIXED: Update current time every minute to refresh "Today/Yesterday" labels
  useEffect(() => {
  ...
  // ✅ FIXED: Use useMemo to make grouping pure and memoized
